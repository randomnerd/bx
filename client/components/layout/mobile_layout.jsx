...
const MobileLayout = Component({
    ...
    renderContent() {
        ...
        if (!this.data.pair && this.state.showMobile != 'chat')
            return;
                ...
                return (
                    <div className="ui main fluid mobile container scrollable">
                        <div className='ui basic segment max100'>
                            ...
                            <Orders direction='sell' pair={this.data.pair} pairId={this.data.pair._id} valute1={this.currName(this.data.pair.currId)} valute2={this.currName(this.data.pair.marketCurrId)}/>
                        </div>
                        <div className='ui basic segment h100 max100'>
                            <h3 className='ui header'>MY ORDERS</h3>
                            <OpenOrders pair={this.data.pair} pairId={this.data.pair._id} valute1={this.data.pair.currId} valute2={this.data.pair.marketCurrId}/>
                        </div>
                    </div>
                )
                break;
                ...
                return (
                    <div className="ui main fluid mobile container">
                        <div className='ui basic segment h100'>
                            ...
                            <Trades pair={this.data.pair} pairId={this.data.pair._id} valute1={this.currName(this.data.pair.currId)} valute2={this.currName(this.data.pair.marketCurrId)}/>
