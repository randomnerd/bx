...
const LastTrades = Component({
    ...
    renderTradesItems() {
        ...
        let max = this.data.tradesMax
            ? parseFloat(this.data.tradesMax.displayAmount())
            : 1;
                ...
                <tr key={item._id} className='animate'>
                    <td className='six wide'>
                        ...
                        <div className='bignum right'>
                            ...
                            {nulls.substr(0, 7 - amount[1].length)}</div>
                    ...
                    <td className={'seven wide arr ' + (item.direction
                        ? 'positive'
                        : 'negative')}>
                        <div className='bignum left'>{price[0]}</div>
                        <div className='bignum dot'>.</div>
                        <div className='bignum right'>
                            <span>{price[1]}</span>{nulls.substr(0, 8 - price[1].length)}</div>
                    </td>
