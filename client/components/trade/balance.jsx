...
const Balance = Component({
    ...
    render() {
        let balance1 = this.data.balance1
            ? this.data.balance1.displayAmount()
            : (0).toFixed(8);
        let balance2 = this.data.balance2
            ? this.data.balance2.displayAmount()
            : (0).toFixed(8);
        return (
            <div className='ui small basic segment teal'>
                ...
                <div className={"ui segments" + (this.props.wide
                    ...
                    <div className='ui small basic segment'>
                        <strong className="name">{this.data.currency1.shortName}:
                        </strong>
                        <span className="value">{balance1}</span>
                    </div>
                    <div className='ui small basic segment'>
                        <strong className="name">{this.data.currency2.shortName}:
                        </strong>
