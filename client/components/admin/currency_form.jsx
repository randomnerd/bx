...
const AdminCurrency = Component({
    ...
    saveCurr(event) {
        ...
        currVals.published = currVals.published
            ? true
            : false;
    ...
    render() {
        this.published = this.currentVal('published')
            ? 'checked'
            : false;
        return (
            <div>
                ...
                <Formsy.Form key={this.props.k} className='ui form' onValidSubmit={this.newCurr} onValid={this.allowSubmit} onInvalid={this.disallowSubmit} ref='curr'>
                    ...
                    <div className='two fields'>
                        ...
                        <div className='field'>
                            ...
                            <a className='ui positive labeled right aligned icon button' onClick={this.props.curr
                                ? this.saveCurr
                                : this.newCurr}>
