...
const WalletsView = Component({
    ...
    getMeteorData() {
        return {balances: Balances.find({}).fetch(), currencies: Currencies.find({}, {
                sort: {
                    name: 1
                }
            }).fetch(), wallets: Wallets.find({}, {
                sort: {
                    createdAt: -1
                }
            }).fetch()};
                    ...
                    <div className="ui padded grid">
                        ...
                        <div className='seven wide column'>
                            <div className='ui fluid mini buttons'>
                                <a className={'ui blue normal button' + (allowWithdraw
                                    ? ''
                                    : ' disabled')} onClick={this.showWithdraw.bind(this, item)}>
                                    Withdraw
                                </a>
