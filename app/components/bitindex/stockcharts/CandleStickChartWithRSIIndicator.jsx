...
let {CandlestickSeries, HistogramSeries, LineSeries, AreaSeries, MACDSeries, RSISeries} = ReStock.series;
let {MouseCoordinates, CurrentCoordinate} = ReStock.coordinates;
let {EdgeContainer, EdgeIndicator} = ReStock.coordinates;

let {TooltipContainer, OHLCTooltip, MovingAverageTooltip, MACDTooltip, RSITooltip} = ReStock.tooltip;
let {StockscaleTransformer} = ReStock.transforms;

let {XAxis, YAxis} = ReStock.axes;
let {MACD, EMA, SMA, RSI} = ReStock.indicator;
