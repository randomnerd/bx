...
let {CandlestickSeries, HistogramSeries, LineSeries, AreaSeries, BollingerSeries} = ReStock.series;
let {EdgeContainer, EdgeIndicator} = ReStock.coordinates;
let {MouseCoordinates, CurrentCoordinate} = ReStock.coordinates;

let {TooltipContainer, OHLCTooltip, MovingAverageTooltip, BollingerBandTooltip} = ReStock.tooltip;
    ...
    return (
      <ChartCanvas ref='chartCanvas' width={this.state.width} height={this.props.height} margin={{
        ...
        <Chart id={1} yMousePointerDisplayLocation='right'
                  ...
                  <DataSeries id={4} indicator={BollingerBand} options={{
                    period: 20,
                    multiplier: 2
                  }}>
                    <BollingerSeries/>
                ...
                <Chart id={2} yMousePointerDisplayLocation='left'
                              yMousePointerDisplayFormat={d3.format('.4s')} height={150}
                              origin={(w, h) => [0, h - 150]}>
                ...
                <TooltipContainer>
                  ...
                  <BollingerBandTooltip forChart={1} onClick={(e) => console.log(e)} origin={[
                    -48, 60
                  ]}/>
                </TooltipContainer>
      </ChartCanvas>
